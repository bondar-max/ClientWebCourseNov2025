...
window.CountriesData = window.CountriesData || {};

CountriesData.App = (function () {
    const countries = [
        {
            name: "Россия",
            cities: [
...
// Основная логика
(function () {
    console.log(CountriesData.App.findCountriesWithMaxCities());
    console.log(CountriesData.App.getCountriesTotalPopulation());
})();